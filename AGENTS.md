...
- После КАЖДОГО коммита обязательно обновить `TODO.md` (перенести сделанное в «Сделано», актуализировать «В работе»/«Бэклог») и `HANDOFF.md` (дата, что сделано с хешами коммитов, текущее состояние, следующий шаг) — и включить их в тот же коммит.
